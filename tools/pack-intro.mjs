 ...
 *
 * Writes: defold-port/assets/sprites/introfx/<fx>-NNN.png
 *         defold-port/main/tiles/introfx_<fx>.atlas   (PLAYBACK_LOOP_FORWARD)
 *         defold-port/assets/sprites/introfx/<fx>-placement.json
 *
...
const OUT_IMG = path.join(ROOT, 'defold-port', 'assets', 'sprites', 'introfx');
const ATLAS_DIR = path.join(ROOT, 'defold-port', 'main', 'tiles');
