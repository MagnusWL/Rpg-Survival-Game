 ...
 *
 *   defold-port/assets/sprites/tear/frame-XX.png   the film
 *   defold-port/main/tiles/tear.atlas              one animation, "tear"
 *
...
const OUT_IMG = path.join(ROOT, 'defold-port', 'assets', 'sprites', 'tear');
const OUT_ATLAS = path.join(ROOT, 'defold-port', 'main', 'tiles', 'tear.atlas');
